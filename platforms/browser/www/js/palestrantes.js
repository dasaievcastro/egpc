...
var app = {
    ...
    bindEvents: function() {
        ...
        function onOnline() {/*
            download("http://egpc.com.br/appegpc/palestrantes.json", "data", "palestrantes");
            download("http://egpc.com.br/appegpc/cronograma.json", "data", "cronograma");
            download("http://egpc.com.br/appegpc/maisinformacoes.json", "data", "maisinformacoes");
        */}
    },
...
function readImage(arquivo,retorno){
  ...
  var size = 0;
  var url = "http://egpc.com.br/appegpc/imagens/"+arquivo;
...
function criarbloco(row, imagem){
        ...
        return '<div id="'+row.id+'" class="portfolio-item"><a href="#" class="wide-title show-wide-text"><h3 class="nomep">'+row.nome+'</h3><em class="nomep">'+row.palestra+'</em><div></div></a><div class="wide-text"><p><img src="'+imagem+'" alt="img">'+row.texto+'</p><a href="#" class="portfolio-close"><i class="fa fa-times"></i>Fechar</a><div class="clear"></div></div></div>'
